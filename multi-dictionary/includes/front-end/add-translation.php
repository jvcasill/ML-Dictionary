...
<form id="mld_add_translation" name="mld_add_translation" action="<?php echo get_bloginfo('url').'/dictionary/add-translation'.$mld_trailing_slash; ?>" method="post" enctype="multipart/form-data">
...
?>
	...
	<div class="mld_term">
        ...
        <input type="text" id="mld_term" name="mld_term" value="<?php echo $mld_term; ?>" size="25" /><br/>
	</div>
...
?>
	<div class="mld_translation">
        ...
        <input type="text" id="mld_translation" name="mld_translation" value="" size="25" /><br/>
	</div>
...
?>
	<div class="mld_definition">
        ...
        <textarea id="mld_definition" name="mld_definition"></textarea><br/>
...
?>
	<div class="mld_target_language_definition">
        ...
        <label for="mld_target_language_definition"><?php _e( 'Target Language Definition: ', 'multilingual-dictionary' ); ?></label>
...
?>
        ...
        <div class="mld_usage_example">
			...
			<input class="wide" type="text" name="mld_usage_example[0]" value="" /><br/>	
...
?>
    ...
    <textarea id="mld_notes" name="mld_notes"></textarea>
        
    <p class="mld_share_notes">Please share any comments or relevant notes regarding your translation here.</p>
...
?>
	<div class="mld_display_author">
        ...
        <label for="mld_display_author" ><?php _e( 'Would you like your name to be shown publicly as the author of this translation? ', 'multilingual-dictionary' ); ?></label>
        <input type="hidden" name="mld_display_author" value="0" />
        <input type="checkbox" value="1" class="form-control" id="mld_display_author" name="mld_display_author" /><br/>
...
?>    
    <?php $mld_captcha_number = rand(1,15); ?>
    	...
    	<div class="mld_captcha">
	    	...
	    	<input type="text" class="mld_captcha_input" id="mld_captcha_input" name="mld_captcha_input" />
...
?>  
    ...
    <p class="mld_center"><input id="add_translation" class="button" type="submit" value="Submit Translation" /></p>
