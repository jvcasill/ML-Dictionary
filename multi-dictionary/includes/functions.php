...
function mld_import_translation($post, $count) {
	...
	if ( strlen($sources_array) > 0 && strpos($sources_array, '||') !== false ) {
	...
	} elseif (strlen($sources_array) > 0 && strpos($sources_array, '|') !== false ) {
	...
	if ( strlen($usage_examples_array) > 0 && strpos($usage_examples_array, '||') !== false ) {
	...
	} elseif (strlen($usage_examples_array) > 0 ) {
